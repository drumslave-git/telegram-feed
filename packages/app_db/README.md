...
Schema v2 adds `rules`, v3 adds `rules.semantic_prompt` (AI rules), v4 adds sync ids, edit times and `sync_tombstones`. `drift_schemas/` holds one dump per version and `test/migration_test.dart`
