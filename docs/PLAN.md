...
**Current phase:** Round L, UI and UX fixes from the full review. **Next task:** L-2.

## Round L — UI and UX fixes

- [ ] L-2 Back closes the search bar or the selection before it leaves a timeline or a comments screen.
